...
**dayPlus(Int)**<br>Defini que a seleção só é possível apartir da data atual mais o número de dias indicado, o calendário inicia automaticamente no mês da data possível de seleção, sendo assim, se o mês atual é Abril e o dayPlus é indicado o valor 30, o calendário iniciará em Maio.
